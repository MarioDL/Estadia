...
public class PnlProveedores extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtNombreProvAgregar.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N

        cmbEstatusAgregar.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        cmbEstatusAgregar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activo", "Inactivo" }));

        btnGuardarAgregar.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        txtNombreProvEditar.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N

        cmbEstatusEditar.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        cmbEstatusEditar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Activo", "Inactivo" }));

        btnGuardarEditar.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        lblIdProveedor.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        tblProveedores.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        btnAgregarProveedor.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
